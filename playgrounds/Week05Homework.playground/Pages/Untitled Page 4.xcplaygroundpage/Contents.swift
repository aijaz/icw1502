...
indirect enum ObjectInSpace {
    ...
    case Neptune
    case Pluto
    case Satellite(ObjectInSpace)
    
    var periodOfRevolution: Double {
        switch self {
        case .Mercury :
            return 87.96
        case .Venus:
        ...
        case .Satellite(let parentObject) :
            return parentObject.periodOfRevolution
        }
    }
}
...
let earth = ObjectInSpace.Earth
earth.periodOfRevolution

let moon = ObjectInSpace.Satellite(earth)
moon.periodOfRevolution
